...
import { buildQuotaLockedResponse, buildRequestDetail, extractRequestConfig, extractUsageFromResponse, saveUsageStats } from "./requestDetail.js";
 ...
 */
export async function handleNonStreamingResponse({ providerResponse, provider, model, sourceFormat, targetFormat, body, stream, translatedBody, finalBody, requestStartTime, connectionId, apiKey, clientRawRequest, onRequestSuccess, reqLogger, toolNameMap, trackDone, appendLog, skillOrchestration, requestGovernor, rtk }) {
  trackDone();
  ...
  const quotaStatus = await saveUsageStats({ provider, model, tokens: usage, connectionId, apiKey, endpoint: clientRawRequest?.endpoint, skillOrchestration });
  ...
  saveRequestDetail(buildRequestDetail({
    provider, model, connectionId, apiKey, skillOrchestration, requestGovernor, rtk,
