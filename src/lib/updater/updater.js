...
const packageName = process.env.UPDATER_PKG_NAME || "arouter";
const port = parseInt(process.env.UPDATER_PORT || "1508", 10);
...
const appPort = parseInt(process.env.UPDATER_APP_PORT || "1508", 10);
